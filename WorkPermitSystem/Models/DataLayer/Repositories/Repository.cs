...
namespace WorkPermitSystem.Models.DataLayer.Repositories
{
    public class Repository<T> : IRepository<T> where T : class
    {
        private WorkPermitContext context { get; set; }
        private DbSet<T> dbSet { get; set; }

        #region MyRegion

        public Repository(WorkPermitContext ctx)
        {
            context = ctx;
            dbSet = context.Set<T>();
        }
        ...
        public virtual async Task Insert(T entity) => await dbSet.AddAsync(entity);
